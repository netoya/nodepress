...
- **Agent Task Protocol:** ver `~/.claude/teams/software-factory/docs/agent-task-protocol.md` para el lifecycle completo (context loading, task receipt, execution, task delivery).
