...
| **Sprint 7** | 2026-06-30 → 2026-07-11 | ✅ CERRADO | Plugin marketplace UI + dependency resolution + dark mode    |
...
| 91               | —            | Dark mode admin panel                                                        | Marta + Nico              | ✅ DONE                            | 82f335e |
| 92               | —            | Plugin ratings schema stub                                                   | Ingrid                    | ✅ DONE                            | 2ce0d70 |
| 93               | —            | Tier 2 bridge — shortcode nesting depth configurable                         | Raúl                      | ✅ DONE                            | 2ce0d70 |

> Ref backlog completo: `docs/process/backlog-sprint7-draft.md`

### Sprint 7 — Estado cierre (2026-04-19)

- **Tickets completados:** 8/10 (#84, #85, #86, #88, #89, #91, #92, #93)
- **Tests:** 402 verdes (suite global)
- **ADRs:** ADR-024 Accepted
- **Features entregadas:** Plugin marketplace UI (browse+search+install+uninstall), dependency resolution (depth-3+cycles), plugin uninstall CLI+REST, plugin search ILIKE, dark mode admin panel, plugin ratings schema stub, NODEPRESS_SHORTCODE_MAX_DEPTH configurable
- **Bloqueados por Alejandro:** #87 verified publishers badge (criterios deadline 2026-07-02 EOD), #90 CLA webhook (Org Admin deadline 2026-04-26)
- **Velocity S7:** 8/10 — P2 todos entregados. #87 y #90 pasan a Sprint 8 si Alejandro no confirma.
